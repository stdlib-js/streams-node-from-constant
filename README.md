...
```javascript
constantStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-constant@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/streams-node-from-constant/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/streams-node-from-constant/actions/workflows/test.yml?query=branch:v0.2.1
