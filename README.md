...
```javascript
import constantStream from 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-constant@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory, objectMode } from 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-constant@v0.2.3-deno/mod.js';
```
